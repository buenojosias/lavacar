...
Route::middleware('auth')->group(function () {
    ...
    Route::livewire('/clientes/{customer}/agendar', 'pages::bookings.create')->name('customers.bookings.create');
    ...
    Route::livewire('/financeiro', 'pages::financial.index')->name('financial.index');
