...
new class extends Component
{
    ...
    #[On('set-company-vehicle-id')]
    public function setCompanyVehicleId($companyVehicleId)
    {
        $this->company_vehicle_id = $companyVehicleId;
    }

    #[On('set-service-variant-id')]
    public function setserviceVariantId($serviceVariantId)
    {
        $this->service_variant_id = $serviceVariantId;
    }

    // #[On('updated-vehicle')]
    // public function updatedVehicle($data)
    // {
    //     $this->company_vehicle_id = $data['companyVehicleId'];
    // }
